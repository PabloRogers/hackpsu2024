...
const SUMMARY_TEMPLATE = `Answer the user's question to the best utilising only the information. DO NOT SPEAK OF THE RESPONSES. If there's no relevant information in the responses, state that politely:
==============================
